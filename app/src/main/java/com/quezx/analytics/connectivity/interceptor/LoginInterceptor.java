...
public class LoginInterceptor implements Interceptor {
	...
	public LoginInterceptor() {
		this.basic = "Basic " + Base64.encodeToString((EndPoints.CLIENT_APP_ID + ":" + EndPoints.CLIENT_SECRET).getBytes()
						, Base64.NO_WRAP);
	}
	...
	public Response intercept(Chain chain) throws IOException {
		...
		Request.Builder requestBuilder = original.newBuilder().header(ServerConstant.AUTHORIZATION, basic).method(original
